          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm">
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
              <div className="flex items-center gap-1">
                ...
                <span className="text-blue-800 text-xs sm:text-sm">{currentLanguage === 'ar' ? 'الباحث' : 'Searcher'}</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-3 h-3 bg-red-600 rounded-full border border-red-800"></div>
                <span className="text-red-800 text-xs sm:text-sm">{currentLanguage === 'ar' ? 'الشخص المفقود' : 'Lost Person'}</span>
              </div>
            </div>
